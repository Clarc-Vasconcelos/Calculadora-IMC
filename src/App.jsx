...
import ilustration2 from './assets/img/ilustration2.svg'
  ...
  return (
    <div className='bigBox'>
      <form onSubmit={imc} className='formStyle'>
        ...
        <div className='boxIlutration'>
          <img className='img1' src={ilustration} alt='logoHealph'/>
          <img className='img2' src={ilustration2} alt='logoHealph'/>
        </div>
        <label>Peso</label>
